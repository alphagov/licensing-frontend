...
def test_get_published_customisation():
    ...
    actual = interaction_customisation_repository.find_published_customisation("rushcliffe", "707-6-1", 0, 1)[0]
...
def test_find_interaction_customisation():
    ...
    actual = interaction_customisation_repository.find_interaction_customisations("rushcliffe", "707-6-1", 0, 1)[0]
